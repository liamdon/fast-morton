...
export const CoordRange10Error = new Error("All input coords must be in Uint10 range (0 - 1023)");
export const CoordRange15Error = new Error("All input coords must be in Uint15 range (0 - 32,767)");
